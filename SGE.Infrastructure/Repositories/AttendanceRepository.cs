    ...
    IAttendanceRepository
{
    ...
    /// <returns>
    ///     A task representing the asynchronous operation, with a collection of Attendance entities for the specified
    ///     employee.
    /// </returns>
    public async Task<IEnumerable<Attendance>> GetByEmployeeAsync(int
            employeeId,
