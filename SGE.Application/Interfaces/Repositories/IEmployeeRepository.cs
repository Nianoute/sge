...
public interface IEmployeeRepository : IRepository<Employee>
{
    ...
    ///     The task result contains the employee that matches the specified email address, or null if no match is found.
    /// </returns>
    ...
    /// <returns>
    ///     A task representing the asynchronous operation.
    ///     The task result contains the employee entity with its department data, or null if no match is found.
    /// </returns>
    ...
    /// <param name="cancellationToken">A cancellation token to notify task cancellation.</param>
    /// <returns>
    ///     A task representing the asynchronous operation. The task result contains an enumerable collection of employees
