...
public interface ILeaveRequestService
{
    ...
    /// </summary>
    /// <param name="dto">
    ///     The details of the leave request to becreated, including employee ID, leave type, start date, end
    ///     date, andreason.
    /// </param>
    /// <param name="cancellationToken">A token to monitor forcancellation requests.</param>
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains the created leave request details
    ///     as a <c>LeaveRequestDto</c>.
    /// </returns>
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains the leave request details as a
    ///     <c>LeaveRequestDto</c>, or <c>null</c> if the leave request is not found.
    /// </returns>
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains a collection of leave requests
    ///     submitted by the specified employee as <c>LeaveRequestDto</c> objects.
    /// </returns>
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains a collection of leave requests
    ///     with the specified status as <c>LeaveRequestDto</c>.
    /// </returns>
    Task<IEnumerable<LeaveRequestDto>>
    ...
    /// </summary>
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains a collection of pending leave
    ///     requests represented as <c>LeaveRequestDto</c>.
    /// </returns>
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result is a boolean indicating whether the update was
    ///     successful.
    /// </returns>
    Task<bool> UpdateStatusAsync(int id, LeaveRequestUpdateDto dto,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains the number of remaining leave days
    ///     as an integer.
    /// </returns>
    Task<int> GetRemainingLeaveDaysAsync(int employeeId, int year,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result indicates whether a conflicting leave
    ///     request exists (true if a conflict is found, otherwise false).
    /// </returns>
    Task<bool> HasConflictingLeaveAsync(int employeeId, DateTime
            startDate, DateTime endDate,
        int? excludeRequestId = null, CancellationToken
