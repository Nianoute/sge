...
public interface ITokenService
{
    ...
    string GenerateAccessToken(ApplicationUser user, IList<string>
        roles);
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result indicates whether the refresh token is
    ///     valid.
    /// </returns>
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result indicates whether the revocation was
    ///     successful.
    /// </returns>
