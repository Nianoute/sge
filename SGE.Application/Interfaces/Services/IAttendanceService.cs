...
public interface IAttendanceService
{
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains the attendance details after
    ///     clock-in.
    /// </returns>
    Task<AttendanceDto> ClockInAsync(ClockInOutDto clockInDto,
    ...
    ///     clock-out.
    /// </returns>
    Task<AttendanceDto> ClockOutAsync(ClockInOutDto clockOutDto,
        CancellationToken cancellationToken = default);
    ...
    ///     An object containing the details for the attendance record such as employee ID, date,
    ///     clock-in time, clock-out time, break duration, and notes.
    /// </param>
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains the details of the created
    ///     attendance record.
    /// </returns>
    Task<AttendanceDto> CreateAttendanceAsync(AttendanceCreateDto
            createAttendanceDto,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains the attendance details for the
    ///     specified ID, or null if no record is found.
    /// </returns>
    ...
    ///     The beginning of the date range for the attendance query. If null, no start date filter is
    ///     applied.
    /// </param>
    ...
    ///     task result contains an enumerable collection of attendance records matching the query parameters.
    /// </returns>
    Task<IEnumerable<AttendanceDto>> GetAttendancesByEmployeeAsync(int
            employeeId, DateTime? startDate = null,
        DateTime? endDate = null, CancellationToken cancellationToken =
            default);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains a collection of attendance details
    ///     for the specified date.
    /// </returns>
    Task<IEnumerable<AttendanceDto>> GetAttendancesByDateAsync(DateTime
            date,
        CancellationToken cancellationToken = default);
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains the attendance details for the
    ///     current day, or null if no attendance record exists.
    /// </returns>
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains the total worked hours as a
    ///     decimal value.
    /// </returns>
