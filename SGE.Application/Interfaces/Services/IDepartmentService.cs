...
public interface IDepartmentService
{
    ...
    /// </summary>
    /// <param name="cancellationToken">A cancellation token that can used to cancel the operation.</param>
    ...
    Task<IEnumerable<DepartmentDto>> GetAllAsync(CancellationToken
    ...
    Task<DepartmentDto?> GetByIdAsync(int id, CancellationToken
        cancellationToken = default);
