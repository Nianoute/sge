...
public interface IAuthService
{
    ...
    /// <returns>A Task that represents the asynchronous operation. When completed successfully, the task returns an <see cref="AuthResponseDto"/> containing authentication details including access token, refresh token, expiration details, and user information.</returns> Task<AuthResponseDto> RegisterAsync(RegisterDto registerDto);
    /// <summary>
