...
///     Provides endpoints for clocking in, clocking out, retrieving attendance records, and calculating attendance-related
///     data.
/// </summary>
[ApiController]
    ...
    : ControllerBase
{
    ...
    public async Task<ActionResult<AttendanceDto>>
        CreateAttendance([FromBody] AttendanceCreateDto createAttendanceDto,
            CancellationToken cancellationToken)
    {
        try
        {
    ...
    /// </summary>
    /// <param name="employeeId">The unique identifier of theemployee.</param>
