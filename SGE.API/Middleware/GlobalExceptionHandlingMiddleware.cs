...
public class GlobalExceptionHandlingMiddleware
{
    ...
    /// <summary>
    ///     Represents the next middleware delegate in the HTTP requestprocessing pipeline.
    ...
    ///     It catches exceptions thrown by downstream middleware, logs them, and provides a consistent error response to
    ///     clients.
    /// </summary>
    ...
    /// <summary>
    ///     Asynchronously handles exceptions that occur during the execution of middleware and generates an appropriate error
    ///     response
    ...
    /// </summary>
    /// <param name="context">
    ///     The current HTTP context that encapsulates all HTTP-specific information about the request and
    ///     response.
    /// </param>
        ...
        Exception exception)
    {
        ...
        var errorResponse = exception switch
        {
            ValidationException validationException =>
                ErrorResponse.CreateValidation(
